...
> Design note: updates stay narrowly scoped and write the approved values directly because `spec_lock.md` is the execution contract; source control provides history instead of ad-hoc backup copies.
