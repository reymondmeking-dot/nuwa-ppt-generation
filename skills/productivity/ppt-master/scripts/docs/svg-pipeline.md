...
> Design note: each pipeline artifact is retained until both preview rendering and native PPTX conversion have consumed it; deleting an intermediate early can make the two outputs diverge.
